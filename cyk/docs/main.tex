...
The main notion of CYK is the fact that, in a CNF grammar, every word in the language can be subdivided into a prefix and a suffix, until the base case, when there are only terminals.
