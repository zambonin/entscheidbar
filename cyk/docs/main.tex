...
Consider Algorithm~\ref{alg:cyk}. We create an upper triangular $n \times n$ matrix $d$, and in Lines 3--7, its diagonals are filled with all rules that produce every letter in $w$.
