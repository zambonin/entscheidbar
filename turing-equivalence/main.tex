...
This formalism is historically known as semi-Thue systems, due to Thue~\cite{}. Other formalisms that deal with strings, such as tag systems, Post canonical systems and Markov algorithms can be reduced to a string rewriting system description~\cite{}.
