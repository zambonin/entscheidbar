...
\emph{Example.~\cite[p. 229]{}} Let a Post canonical system $\mathcal{P} = (\Sigma, X, P)$ that describes multiplication of unary strings, such that $\Sigma = \{1, \times, =\}, X = \{1 \times 1 = 1\}, P = \{p_{1}, p_{2}\}$, where $p_{1} = 


% \$_{1} \times \$_{2} = \$_{3} \rightarrow \$_{1}1 \times \$_{2} = \$_{3}\$_{2}, \$_{1} \times \$_{2} = \$_{3} \rightarrow \$_{2} \times \$_{1} = \$_{3}\}$
