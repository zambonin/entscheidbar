...
This formalism is historically known as a semi-Thue system, and was first defined by Thue~\cite{}\footnote{This work was translated to English by Power~\cite{}.}. It is abstract enough to represent other definitions, for instance, that of a free monoid in abstract algebra. Still, we are interested in concepts from formal language theory. Fortunately, there are a handful of constructions that can be directly related to string rewriting systems. A Post canonical system 
% Other formalisms based on string rewriting, such as tag systems, Post canonical systems and Markov algorithms, can be reduced to a string rewriting system description~\cite{}. 
