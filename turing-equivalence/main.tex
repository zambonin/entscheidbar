...
\begin{align}
    p_{1} = \$_{1} \times \$_{2} = \$_{3} \rightarrow \$_{1}1 \times \$_{2} = \$_{3}\$_{2}, \\
    p_{2} = \$_{1} \times \$_{2} = \$_{3} \rightarrow \$_{2} \times \$_{1} = \$_{3}.
\end{align}
...
\end{align}
Observe that Eq.~\ref{eq:1} is given by the only axiom in $X$. We apply $p_{1}$ in Eqs.~\ref{eq:2},~\ref{eq:3} and~\ref{eq:4}, to expand the first and last variables. Eq.~\ref{eq:5} swaps the terms around with $p_{2}$ and Eqs.~\ref{eq:6} and~\ref{eq:7} use $p_{1}$ again to carry out the remaining multiplications. Further, observe that
\begin{align}
    \$_{1} \times \$_{2} = \$_{3} \rightarrow \$_{1}1 \times \$_{2} = \$_{3}\$_{2}
\end{align}
