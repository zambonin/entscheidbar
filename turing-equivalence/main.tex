...
\end{align}
is called a Diophantine set. The set of Pythagorean triples is Diophantine, as is the set of natural numbers, prime numbers, and many others. In fact, we will see that these sets can be thought entirely as other concepts.
