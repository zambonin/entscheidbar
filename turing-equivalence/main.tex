...
Let a tag system $\mathcal{T} = (\Sigma, X, P)$, with $n = 2, \Sigma = \{a, b, c\}, X = \{a^{n} | n \in \mathbb{N}^{*}\}, P = \{p_{1}, p_{2}, p_{3}\}$. We wish to compute Collatz sequences, as done by de Mol~\cite{}.
