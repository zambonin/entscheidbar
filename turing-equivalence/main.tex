...
\end{align}
Observe that Eq.~\ref{eq:1} is given by the only axiom in $X$. We apply the first production rule, $p_{1}$, in Eqs.~\ref{eq:2},~\ref{eq:3} and~\ref{eq:4}, to expand the first 
