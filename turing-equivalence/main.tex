...
With these definitions in mind, we may look at how the question of Hilbert was solved. First, note that all Diophantine sets are recursively enumerable, since a Turing machine can enumerate all possible pairs of variables and unknowns and then test if they are valid solutions. However, are all r.e. sets also Diophantine, that is, can a Turing machine decide whether a tuple of unknowns solves a Diophantine equations with fixed variables? This was answered negatively by 
