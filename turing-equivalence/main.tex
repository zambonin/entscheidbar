...
%\begin{figure}[h]
%    \centering
%    \includegraphics[width=1\textwidth]{figs/gol_mt_highlevel.pdf}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.3\textwidth]{figs/gol_mt.pdf}
    \caption{Patterns used in the Turing machine.}
    \label{fig:gol_mt}
    \qquad
    \includegraphics[width=0.2\textwidth]{figs/gol_mt_highlevel.pdf}
    \caption{Turing Machine diagram.}
    \label{fig:gol_mt_highlevel}
\end{figure}
