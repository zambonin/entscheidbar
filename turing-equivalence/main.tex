...
An abstract rewriting system is defined as a set $S$ and a binary relation $R \subseteq S \times S$, usually denoted by $\rightarrow$. We also define the reflexive transitive closure $\stackrel{*}{\rightarrow}$, the symmetric closure $\leftrightarrow$ and its reflexive transitive closure $\stackrel{*}{\leftrightarrow}$ of the binary relation
