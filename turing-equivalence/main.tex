...
First, a possible proof strategy is based on the concept of a recursively enumerable (r.e.) language. Indeed, a string rewriting system is a formal language. Then, one must prove that a general SRS generates a set of outputs that is a r.e. subset of the set of all possible words over its alphabet. This means that 
