...
Note that this computational process may actually never stop, \emph{i.e.} $f(x)$ is an undefined value. It would be interesting to determine this behaviour for every pair of algorithms --- or ``computer programs'' --- and inputs. Called the halting problem, this was proved to be impossible througt 
