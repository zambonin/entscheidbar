...
We will follow the proof idea due to Matiyasevich~\cite[Chap. 5]{}. Usual definitions of Turing machines and their composability are given in Sections 5.1 and 5.2, respectively. Two special symbols for the beginning of tape and empty value are used, as well as four usual alphanumeric symbols, to compose the total alphabet. All machines used are deciders in the sense that the only final states are ``yes'' or ``no''.
