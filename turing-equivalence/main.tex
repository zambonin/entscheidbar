...
\end{align}
These rules actually compute $\frac{3n + 1}{2}$, reducing the length of the Collatz sequence but still converging to $1$. Without loss of generality, let us compute the Collatz sequence for $k = 3$.
aaaaa
aaaby
abyby
ybyby
