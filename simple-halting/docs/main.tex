...
It is known that there exists no procedure which can determine if any program halts or not, as seen above. However, a decider can know if strings belong to a certain formal language. This is exactly the set of recursive languages. 
