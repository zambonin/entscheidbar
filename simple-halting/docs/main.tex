...
Identifying state repetitions is a simpler approach, since it needs not to look at all the possible states for a program. Since a program cannot have more than $1000$ lines, the only instruction that can alter this behaviour is \texttt{CALL}.
